...
/**
 * <b>类名称：</b> PackageUtils <br/>
 * <b>类描述：</b> 应用程序安装与卸载相关工具类<br/>
 * <b>创建人：</b> 林肯 <br/>
 * <b>修改人：</b> 编辑人 <br/>
 * <b>修改时间：</b> 2015年07月29日 上午11:51 <br/>
 * <b>修改备注：</b> <br/>
 *
 * @version 1.0.0 <br/>
 */
...
public class PackageUtils {
     ...
     * @return {@link com.drawthink.base.utils.PackageUtils#INSTALL_SUCCEEDED} means install success, other means failed. details see
     * {@link com.drawthink.base.utils.PackageUtils}.INSTALL_FAILED_*. same to {@link PackageManager}.INSTALL_*
    ...
    private static int installSilent(Context context, String filePath, String pmParams) {
        ...
        DebugLog.e("installSilent successMsg:" + commandResult.successMsg + ", ErrorMsg:" + commandResult.errorMsg);
    ...
    private static int uninstallSilent(Context context, String packageName, boolean isKeepData) {
        ...
        DebugLog.e("uninstallSilent successMsg:" + commandResult.successMsg + ", ErrorMsg:" + commandResult.errorMsg);
        if (commandResult.errorMsg == null) {
     ...
     * <ul>
     * <strong>注意:</strong>
     * <li>你需要添加 <strong>android.permission.GET_TASKS</strong> 权限 在 manifest</li>
     * </ul>
     *
     * @param context
     * @param packageName
    ...
    private static int getInstallLocation() {
        ...
        if (commandResult.result == 0 && commandResult.successMsg != null && commandResult.successMsg.length() > 0) {
            try {
                ...
                e.printStackTrace();
                DebugLog.e("pm get-install-location error");
            }
        }
