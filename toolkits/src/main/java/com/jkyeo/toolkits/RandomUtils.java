...
/**
 * <b>类名称：</b> RandomUtils <br/>
 * <b>类描述：</b> 随机字符串相关工具类<br/>
 * <b>创建人：</b> 林肯 <br/>
 * <b>修改人：</b> 编辑人 <br/>
 * <b>修改时间：</b> 2015年07月29日 下午3:41 <br/>
 * <b>修改备注：</b> <br/>
 *
 * @version 1.0.0 <br/>
 */
...
public class RandomUtils {
    ...
    /**
     * 生成指定长度的随机随机字符串,随机字符串包含大小写字母和数字
     * get a fixed-length random string, its a mixture of uppercase, lowercase letters and numbers
     *
     * @param length
     * @return
     * @see com.drawthink.utils.RandomUtils#getRandom(String source, int length)
     */
     ...
     * <li>else see {@link com.drawthink.utils.RandomUtils#getRandom(char[] sourceChar, int length)}</li>
     * </ul>
     */
